    ...
    <div className="space-y-6">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-gray-600">AI-powered market analysis and predictive opportunity detection</p>
        </div>
      </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-900">{dashboardStats.totalCompanies.toLocaleString()}</p>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-green-900">{dashboardStats.activeOpportunities}</p>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-violet-50 border border-purple-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-purple-900">{dashboardStats.fundingRounds}</p>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-orange-900">{dashboardStats.predictionAccuracy}%</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {marketTrends.map((trend) => (
              <div key={trend.id} className="bg-white border border-gray-200 rounded-xl p-6 cursor-pointer transition-all duration-300 hover:shadow-lg hover:scale-105">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs font-medium border ${
                        trend.trend === 'up' ? 'text-green-600 bg-green-50 border-green-200' : 
                        trend.trend === 'down' ? 'text-red-600 bg-red-50 border-red-200' : 'text-gray-600 bg-gray-50 border-gray-200'
                      }`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6 h-full shadow-sm">
        ...
        <div className="lg:col-span-2">
          <div className="bg-gradient-to-br from-gray-50 to-blue-50 border border-gray-200 rounded-xl p-6 h-full shadow-sm">
            <div className="space-y-4">
              ...
              {aiResponse && (
                <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                  ...
                  <div className="text-sm text-gray-700 whitespace-pre-line">{aiResponse}</div>
                </div>
              )}
              ...
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2 transition-all duration-200 shadow-md hover:shadow-lg"
                >
                  {isLoading ? (
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Market News Feed</h3>
              </div>
              <div className="flex items-center space-x-2">
                <button
                ...
                newsItems.map((item) => (
                  <div 
                    ...
                    className={`border border-gray-200 rounded-lg p-4 hover:shadow-md transition-all duration-300 cursor-pointer ${
                      selectedNewsItem?.id === item.id ? 'ring-2 ring-blue-500 bg-blue-50' : ''
                    }`}
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-700 leading-relaxed mb-2">{item.title}</p>
                        {item.summary && (
